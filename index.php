...
<div class="home">
    <div class="nav-bar">
        ...
        <div class="right-side">
            ...
            <ul id="nav-links">
                ...
                <li><a href="f1.html"><i class="fa fa-leaf" aria-hidden="true"></i>Crops</a>
                <li><a href="rent_machine.html"><i class="fa fa-bus" aria-hidden="true"></i>Rent machinery</a></li>
                <li><a href="cultivation.html"><i class="fa fa-asl-interpreting"></i>Cultivation &amp; Protection</a></li>
    ...
    <div class="mobile_nav">
        ...
        <div class="mobile_footer">
           <p>Copyright&copy; 2024 Kheti-Sathi. All Rights Reserved</p>
        </div>
    </div>
...
<div class="sub-home">
    ...
    <div class="about-agzone">
        ...
        <div class="about">
            ...
            <div class="image">
                <p id="inc">About Kheti-Sathi, Inc.</p>
                <img src="./Images/about-agzone.jpeg">
               
            </div>
            <div class="about-para">
                <p>
                    At <span>Kheti-Sathi</span>, based in Kandy,
    ...
    <section class="footer">
        <div class="left-side-footer">
            <p>&copy;2024 All Rights Reserved.Kheti-Sathi.</p>
        </div>
        <div class="right-side-footer">
            <p>By<a href="index.html">PCE CSE Students</a></p>
        </div>
    </section>
